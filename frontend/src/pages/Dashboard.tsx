      ...
      <main className="dashboard">
        ...
        <section className="graph-container">
          <div className="revenue-chart">
            ...
            <BarChart data_1={[300, 144, 433, 655, 237, 755, 190]} data_2={[200, 444, 343, 556, 778, 455, 990]} title_1="Revenue" title_2="Transactions" bgColor_1="rgb(0,115,255)" bgColor_2="rgba(53,162,235,0.8" />
...
const WidgetItem = ({
  ...
  <article className="widget">
    ...
    <div
      ...
      style={{
        background: `conic-gradient(${color} ${(Math.abs(percentage) / 100) * 360
